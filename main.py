...
class CNN(Module):
	def __init__(self, num_channels, num_classes):
		...
		self.conv1 = Conv2d(in_channels=num_channels, out_channels=25, kernel_size=(5, 5), stride=1, padding=0)
		self.bn1 = nn.BatchNorm2d(num_features=25)  # batch normalzation layer
		self.relu1 = ReLU()
		self.maxpool1 = MaxPool2d(kernel_size=(2, 2), stride=(2, 2))
				
		# second set CONV -> BatchNorm -> RELU -> POOL
		self.conv2 = Conv2d(in_channels=25, out_channels=50, kernel_size=(3, 3), stride=1, padding=0)
		self.bn2 = nn.BatchNorm2d(num_features=50)  
		self.relu2 = ReLU()
		self.maxpool2 = MaxPool2d(kernel_size=(2, 2), stride=(2, 2))
				
		# third set
		self.conv3 = Conv2d(in_channels=50, out_channels=100, kernel_size=(3, 3), stride=1, padding=0)
		...
		self.fc1 = Linear(in_features=400, out_features=400) # fully connected layer 
		self.relu4 = ReLU()
		self.fc2 = Linear(in_features=400, out_features=400) # fully connected layer 2
		self.relu5 = ReLU()
		self.fc3 = Linear(in_features=400, out_features=num_classes) # fully connected layer 3
